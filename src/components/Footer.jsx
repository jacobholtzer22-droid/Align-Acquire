      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-8 mb-6 md:mb-8">
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-sm md:text-base text-gray-400 mb-4 max-w-md leading-relaxed">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm md:text-base">
              <li><a href="#features" className="hover:text-brand-green transition">Features</a></li>
              <li><a href="#why-us" className="hover:text-brand-green transition">Why Choose Us</a></li>
        ...
        <div className="border-t border-gray-800 pt-6 md:pt-8 text-center text-xs md:text-sm text-gray-400">
          <p>&copy; {new Date().getFullYear()} Align & Acquire. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
